...
urlpatterns = [
    ...
    path('quiz_attempts_owner/<int:quiz_id>/', views.quiz_attempts_owner, name='quiz_attempts_owner'),
    ...
    path('test_quiz/<int:quiz_id>/', views.test_quiz, name='test_quiz'),
    path('start_quiz/<int:quiz_id>/', views.start_quiz, name='start_quiz'),
    path('start_test_quiz/<int:quiz_id>/', views.start_test_quiz, name='start_test_quiz'),
    path('submit_quiz/<int:quiz_id>/', views.submit_quiz, name='submit_quiz'),
    path('submit_test_quiz/<int:quiz_id>/', views.submit_test_quiz, name='submit_test_quiz'),
    path('quiz_results/<int:attempt_id>/', views.quiz_results, name='quiz_results'),
    path('quiz_test_results/<int:attempt_id>/', views.quiz_test_results, name='quiz_test_results'),
