    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subjects', models.CharField(choices=[('maths', 'Maths'), ('english', 'English'), ('science', 'Science')], default='maths', max_length=255)),
                ('email', models.EmailField(max_length=254, unique=True)),
                ('status', models.CharField(choices=[('student', 'student'), ('teacher', 'teacher')], default='student', max_length=100)),
                ('school', models.TextField(blank=True, default='', max_length=50, verbose_name='School')),
